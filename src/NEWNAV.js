    ...
    <nav className={`navbar ${isShrunk ? 'shrunk' : ''}`}>
      ...
      <div className={`left ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
        ...
        <ul className="nav-links">
          ...
          <li><Link to="/about-us" onClick={closeMobileMenu} className={location.pathname === '/about-us' ? 'active' : ''}>About</Link></li>
          <li><Link to="/contact-us" onClick={closeMobileMenu} className={location.pathname === '/contact-us' ? 'active' : ''}>Contact</Link></li>
